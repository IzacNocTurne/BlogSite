			...
			<div class="col-md-12 my-order">
				<div class="content-section">
					<form name="w_form" action="<%=request.getContextPath()%>/board?cmd=board_write" method="post">
						<!-- filepath : 이미지업로드 경로 -->
						<input type="hidden" name="filepath" value="/editor/upload/" /> <input type="hidden" name="id" value="${sessionScope.id}" />

						<fieldset class="form-group">
							<legend class="border-bottom mb-4">New Post</legend>
							<div class="form-group">
								<label class="form-control-label">Title</label> <input class="form-control form-control-lg" type="text" name="title" autofocus>
							</div>
							<div class="form-group">
								<label class="form-control-label">Content </label>
								<p class="text-primary float-right">지도 첨부 방법▶ /nmap/중앙대로 708/nmap/</p>
